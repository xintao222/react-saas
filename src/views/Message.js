...
import LargeImageSelect from '../components/LargeImageSelect'
...
export default class Message extends React.Component {
    ...
    openLargeImageSelect = () => {
        this.setState({
            showLargeImageSelect: true,
        });
    };
    ComfirmLargeImage = (item) => {
        if(item){
            this.setState({
                showLargeImageSelect: false,
                imageData:item,
        ...
        else this.setState({ showLargeImageSelect: false, })
    };
    openAudioSelect = () => {
        this.setState({
    ...
    fileChange = event => {
        ...
        if (event.target.files && event.target.files[0]) {
            ...
            formDatas.append("Authorization", localStorage.getItem("Authorization"));
            formDatas.append("imageType", 2);
    ...
    render() {
        const { 
            ...
            showLargeImageSelect,imageData,showImageTextSelect,imageTextData,
        ...
        return (
            <Card title="群发消息" bordered={false}>
                ...
                <div className="card-container">
                    <Tabs onChange={this.tabChange} type="card">
                        ...
                        <TabPane tab="图片" key="1">
                        {
                            ...
                            <Space size="middle">  
                                <div onClick={() => this.openLargeImageSelect() } className="choose" style={{marginLeft:40}}>
                                    <PlusOutlined  style={{marginTop:80,fontSize:40,color:'#ddd'}}/>
                                    <div style={{marginTop:15,fontSize:17,color:'#d6d6d6'}}>从素材库中选择</div>
                                </div>
                                <div className="choose">
                ...
                {
                    showLargeImageSelect?(
                        <LargeImageSelect ComfirmSelect={this.ComfirmLargeImage} />
                    ):''
                }
                {
                    showImageTextSelect?(
