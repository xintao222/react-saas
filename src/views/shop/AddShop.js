...
export default class AddShop extends React.Component {
    ...
    onFinish = values =>{
        ...
        https.fetchPost("/yx/user/add.action", params)
        .then(data => {
            ...
            <Card title="商户管理" bordered={false}>
                ...
                >
                    <Form.Item label="&emsp;&emsp;&emsp;商户ID">
                        ...
                        <Input autoComplete={'off'} placeholder="请输入商户ID" />
                        </Form.Item>
                    </Form.Item>
                    ...
                    <Form.Item name="status" label="&emsp;&emsp;&emsp;&emsp;状态">
                        <Radio.Group>
                            <Radio value="1">正常状态</Radio>
                            <Radio value="2">欠费状态</Radio>
                        </Radio.Group>
                    </Form.Item>
                    <Form.Item label="每日流量限制">
                        <Form.Item name="dailyLimit" noStyle>
                            <Input autoComplete={'off'} placeholder="请输入每日流量限制"/>
                        </Form.Item>
                    </Form.Item>
